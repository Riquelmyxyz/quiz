...
const questionText = document.getElementById("quention-text");
const answerDiv = document.getElementById("next-buttom");
...
function showQuestion() {
    const q = question[serie][disciplina][currentQuestion];
